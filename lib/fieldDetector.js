...
function afFindLabelText(el) {
  ...
  // Try to find the nearest text node before the field (common pattern for forms without <label>,
  // and for long job application questions like "Why do you want to work here?")
  ...
  // If nothing nearby, try to find text in the parent block (common pattern for
  // job application questions wrapped in a single div with the textarea)
